...
DHZB I SOP Bett-Thorax Kinder Nr. 456 I Version Nr. 2.0 
...
_Die digitale Röntgenanforderung wird mit ausgefüllter ROE-Nummer abgeschlossen und ist in der digitalen Krankenakte des Patienten gespeichert (Aufbewahrungspflicht)._ 
...
2. Verordnung zum Schutz vor der schädlichen Wirkung ionisierender Strahlung (Strahlenschutzverordnung - StrlSchV) 
...
**==> picture [432 x 577] intentionally omitted <==**
...
- Bei beatmeten Kindern evtl. _Inspiration hold_ am Beatmungsgerät (durch Intensivpersonal) 
...
||||||||||
|---|---|---|---|---|---|---|---|---|
|**Gewicht/Alter**|||||**KV**|**mAs**||**DRG Richtwerte**|
|||**Format**|||||||
||**Alter**||**Raster**|**Abstand**|||**Filter**|**DFP [cGyxcm²]**|
|||**Detektor**|||||||
|||||||||**bzw. [µGyxm²]**|
||||||||||
||||||||||
...
**==> picture [259 x 534] intentionally omitted <==**

**==> picture [163 x 577] intentionally omitted <==**
