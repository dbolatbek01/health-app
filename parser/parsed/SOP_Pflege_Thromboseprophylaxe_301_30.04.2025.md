...
Bei Patienten mit operativen Eingriffen sowie akuten oder chronischen Erkrankungen wie Herzrhythmusstörungen oder Herzinsuffizienz besteht ein erhöhtes Risiko für venöse Thrombosen. Die Risikoeinschätzung erfolgt anhand spezifischer Faktoren. Die Indikation zur venösen Thromboembolieprophylaxe sollte individuell und risikoadaptiert erfolgen [\(S3-Leitlinie Prophylaxe der](https://register.awmf.org/de/leitlinien/detail/003-001)  [venösen Thromboembolie \(VTE\),](https://register.awmf.org/de/leitlinien/detail/003-001) 2015).

Um Thromboembolien zu vermeiden, werden spezifische, auf den Patienten abgestimmte Präventionsmaßnahmen eingesetzt. Wesentliche Ziele einer Thromboseprophylaxe sind:

- Verbesserung des venösen Rückflusses aus den tiefen Beinvenen.
- Komprimierung der dilatierten Beinvenen, um den Blutfluss zu fördern.
- Erhöhung des Muskeltonus zur Unterstützung der venösen Rückführung.
- Beeinflussung der intravasalen Gerinnung, um die Gerinnungsneigung zu reduzieren.
- Frühzeitige Erkennung von Thromboseanzeichen, um rechtzeitig intervenieren zu können.

Diese SOP gilt für die Versorgung von Patienten jeden Alters in der operativen und nicht operativen Medizin, die aufgrund ihrer Erkrankung oder Intervention ein Risiko für Thrombosen aufweisen. Die für Charité und DHZC geltenden krankenhaushygienischen Standards sind im [Leitfaden der](http://hygieneleitfaden.charite.de/Hygieneleitfaden.complete/Hygieneleitfaden.html) [Krankenhaushygiene](http://hygieneleitfaden.charite.de/Hygieneleitfaden.complete/Hygieneleitfaden.html) ausgeführt.
...
- 1. Basismaßnahmen: Dazu zählen frühzeitige Mobilisation, körperliche Aktivität und spezielle Bewegungsübungen, die den venösen Rückfluss fördern.
- 2. Physikalische Maßnahmen: Hierzu gehören kompressive Maßnahmen wie das Tragen von Antithrombose-Strümpfen (AT-Strümpfe), die den venösen Druck erhöhen und die Blutzirkulation unterstützen.
- 3. Medikamentöse Maßnahmen: Diese beinhalten die prophylaktische Verabreichung von Antikoagulanzien, welche die Blutgerinnung hemmen und somit das Risiko der Thrombusbildung verringern.

| Version 4.0 | Letzte Überprüfung  |         |
|-------------|---------------------|---------|
| SOP 301     | Freigabe am         | Seite   |
|             | Nächste Überprüfung | 1 von 3 |
...
Am häufigsten treten Venenthrombosen in den Beinen oder im Becken auf.

Typische Symptome einer Beinvenenthrombose sind:

Beinschwellung, Schmerzen, Spannungsgefühl, verstärkte oberflächliche Venenzeichnung, Zyanose.

Klassische klinische Zeichen sind nach den Kriterien von Meyer (Druckschmerzhaftigkeit an der medialen Seite des Unterschenkels), Homans (Wadenschmerz bei Dorsalextension des Fußes) und Payr (Fußsohlenschmerz bei Druck auf die Fußsohle) beschrieben. Älteren Studien zufolge zeigen diese Zeichen bei ambulanten Patienten eine Sensitivität von 60-90%, sind jedoch unspezifisch und können bei alleiniger Anwendung zu vielen falsch-positiven Befunden führen.
...
| Auf ärztliche Anordnung                                        | z.B. medizinische Kompressionsstrümpfe oder Kompressionsverbände.                                                                                                                              |  |  |  |  |  |
| Medikamentöse Maßnahmen (auf schriftliche ärztliche Anordnung) |                                                                                                                                                                                                |  |  |  |  |  |
| Prophylaktische Behandlung                                     | Heparinen (intravenös oder subkutan)                                                                                                                                                           |  |  |  |  |  |
| bei mittlerem oder hohem                                       | Thrombininhibitoren                                                                                                                                                                            |  |  |  |  |  |
| Thromboserisiko                                                | Vitamin-K-Antagonisten                                                                                                                                                                         |  |  |  |  |  |
...
Das An- und Ausziehen von AT-Strümpfen sowie das Wickeln der Beine erfolgt immer am liegenden Patienten. Die Beine sollen vorher mind. 20 min. in entstauender Position hochgelagert werden.

Bei AT-Strümpfen bzw. gewickelten Beinen wird zusätzlich die Zehendurchblutung geprüft Ertastens des Pulses an der A. dorsalis pedis.

![](_page_2_Picture_9.jpeg)

AT-Strümpfe bzw. elastische Binden werden bei Verschmutzung gewechselt.

Ein Kompressionsverband soll nur angelegt werden, wenn z. B. aus anatomischen Gründen kein AT-Strumpf passt oder eine höhere Kompression erforderlich ist.

| Anlegen von AT-Strümpfen und Kompressionsverbänden |                                                                          |  |  |
|----------------------------------------------------|--------------------------------------------------------------------------|--|--|
